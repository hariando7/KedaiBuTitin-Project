        ...
        <div class="flex justify-between">
            <div class="flex w-full gap-2">
                <input type="date" id="start_date" name="start_date" value="{{ request('start_date') }}"
                    class="border border-orange-400 px-3 py-2 rounded" placeholder="Tanggal Awal"
                    max="{{ \Carbon\Carbon::today()->toDateString() }}">
                <input type="date" id="end_date" name="end_date" value="{{ request('end_date') }}"
                    class="border border-orange-400 px-3 py-2 rounded" placeholder="Tanggal Akhir"
                    max="{{ \Carbon\Carbon::today()->toDateString() }}">
                <script>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2 text-center ">
                        <span class="inline-flex overflow-hidden rounded-md border bg-white shadow-sm">
                            ...
                            <form action="{{ route('prasmanan_orders.destroy', $order->id) }}" method="POST"
