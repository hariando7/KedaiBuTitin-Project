        ...
        <div
            ...
            <form class="space-y-4" method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-500 text-sm mt-4 leading-relaxed">Register to your account and explore a
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                        ...
                        <input id="name" type="text"
                            class="form-control form-control w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-blue-600 @error('name') is-invalid @enderror"
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                        <input id="email" type="email"
                            class="form-control w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-blue-600 @error('email') is-invalid @enderror"
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                        <input id="password" type="password"
                            class="form-control w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-blue-600 @error('password') is-invalid @enderror"
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                        <input id="password-confirm" type="password"
                            class="form-control w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-blue-600"
                ...
                <p class="text-sm !mt-8 text-center text-gray-800">Sudah punya akun?
                    @if (Route::has('login'))
                    <a href="{{ route('login') }}"
